...
#
# usage: xlsx2mysql("test.xslx", open("test.csv", "w+"))
# parameters:
...
#
def xlsx2mysql(infilepath, outfile, sheetid=1, dateformat=None, delimiter=",", sheetdelimiter="--------", skip_empty_lines=False):
    ...
    if options.recursive:
        ...
        if len(args) < 1:
            ...
            if len(args) > 1:
                ...
                xlsx2mysql(args[0], outfile, **kwargs)
                outfile.close()
            else:

...
<template:insert template="../styles/template-admin.jsp">
  <template:put name="title" content="Delete Tickets" direct="true" />
  <template:put name="menu" content="../admin/../admin/menu.jsp" />
  <template:put name="content" content="../admin/../admin/content/ticketscontent.jsp" />
</template:insert>
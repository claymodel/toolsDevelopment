...
<head>
<title><bean:write name="configForm" property="title" /> :: StaffArea - Logged in as <bean:write name="loginBean" property="login" filter="true" /></title>
...
<div class="navi">
  ...
  <p class="left-navbar">StaffArea</p>
...
<h1 class="main"><bean:write name="configForm" property="title" /> :: StaffArea</h1>
<div class="main">
  <div class="errors"><html:errors  property="general"/></div>
  <p>You belong to the following groups:<br />
    <logic:iterate id="group" name="staffBean" property="groupName"> &raquo;&nbsp;<bean:write name="group" /><br />
    </logic:iterate> </p>
  <table border="1" cellpadding="2" cellspacing="1" summary="new tickets">
    <caption>
    New tickets
    </caption>
    <form method="post" action="takeTickets.do">
      <tr>
        <th>ID</th>
        <th>From</th>
        <th>Subject</th>
      ...
      <logic:iterate id="ticket" name="newTickets">
      <tr>
        <td><bean:write name="ticket" property="id" /></td>
        <td><bean:write name="ticket" property="user" /></td>
        <td><bean:write name="ticket" property="subject" /></td>
        ...
        <td> <input type="checkbox" name="ticketId" value="<bean:write name="ticket" property="id" filter="false" />
          " /> </td>
      </tr>
      </logic:iterate>
      <tr>
  ...
  <table border="1" cellpadding="2" cellspacing="1" summary="staff tickets">
    ...
    <logic:iterate id="ticket" name="staffsTickets">
    <tr>
      <td><bean:write name="ticket" property="id" /></td>
      <td><bean:write name="ticket" property="user" /></td>
      <bean:define id="ticketId" name="ticket" property="id"/>
      <td><html:link title="Work on this ticket" href="getMessages.do" paramId="tId" paramName="ticketId"><bean:write name="ticket" property="subject" /></html:link></td>
      <td><bean:write name="ticket" property="group" /></td>
      <td><bean:write name="ticket" property="status" /></td>
      <td><bean:write name="ticket" property="timeSince" /></td>
      <td><bean:write name="ticket" property="priority" /></td>

...
import hnu.admin.form.ConfigForm;
...
public class ConfigAction extends org.apache.struts.action.Action {
  /**
   * Executes Struts-Action:
   * Writes change to the HNU Config Properties File.
   ...
   */
    public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        if (mapping.getName().equals("showconfigForm")) {

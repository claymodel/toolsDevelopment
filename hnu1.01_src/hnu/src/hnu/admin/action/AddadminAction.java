...
import hnu.admin.form.AddAdminForm;
...
public class AddadminAction extends org.apache.struts.action.Action {
  /**
   ...
   */
    public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        String sql = "INSERT INTO TAdmin(aLogin,aPass) VALUES ('" + addAdminForm.getLoginname() + "','" + PasswordHash.getSHAString(addAdminForm.getPassword1()) + "')";

        if (DataBaseConnection.execute(sql)) {
            addAdminForm.reset(mapping, request);

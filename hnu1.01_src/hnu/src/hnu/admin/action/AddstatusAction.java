...
import hnu.admin.form.AddstatusForm;
...
public class AddstatusAction extends org.apache.struts.action.Action {
  /**
   ...
   */
    public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        AddstatusForm addstatusForm = (AddstatusForm) form;
        ActionErrors errors = new ActionErrors();

        String sql = "INSERT INTO TStatus(stText) VALUES ('" + addstatusForm.getText() + "')";

        if (DataBaseConnection.execute(sql)) {
            addstatusForm.reset(mapping, request);

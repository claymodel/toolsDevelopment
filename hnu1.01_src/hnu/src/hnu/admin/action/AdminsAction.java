...
import hnu.admin.form.AdminsForm;
import hnu.helper.admin.AdminDeleter;
...
public class AdminsAction extends org.apache.struts.action.Action {
  /**
   * Executes Struts-Action:
   * Executes Admins-Deleting from Business-Logic-Class AdminDeleter.
   ...
   */
    public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        AdminsForm adminsForm = (AdminsForm) form;
        ActionErrors errors = new ActionErrors();
        String[] id = adminsForm.getId();

        AdminDeleter adminDeleter = new AdminDeleter();

        errors = adminDeleter.execute(id);

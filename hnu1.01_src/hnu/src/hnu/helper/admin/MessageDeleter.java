...
public class MessageDeleter {
    ...
    */
     ...
     * Method deletes all messages-accounts in the database with the id the String[] is containing.
    */
    ...
    */
    public ActionErrors execute(String messagesToDelete) {
        ...
        if (messagesToDelete.indexOf(",") != -1) {
            sql = "DELETE FROM TMessage WHERE mId IN(" + messagesToDelete + ")";
        } else {
            if (messagesToDelete.indexOf("'") == -1) {
                messagesToDelete = "'" + messagesToDelete + "'";
            }

            sql = "DELETE FROM TMessage WHERE mId=" + messagesToDelete;
        }

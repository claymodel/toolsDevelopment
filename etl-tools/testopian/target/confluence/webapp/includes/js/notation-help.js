AJS.toInit(function ($) {
    ...
    sectionLinks.each( function () {
        ...
        thisSectionLink.click(function (e) {
            var hideAll = thisSectionLink.hasClass("active"); // User clicked on already-selected section - hide all.
            ...
            if (!hideAll) {
                thisSectionLink.addClass("active");
            }
    ...
    $("#print-friendly-help-toggle").click(function () {
        $("#lefthand-nav").toggleClass("hidden"); // toggle() is broke in IE8 for table elements (http://dev.jquery.com/ticket/4661) in jquery 1.3.2
    });
});